opcodes:
```
0 0 0 0 0|D S T  STOREREG  ACC->R[SRC]
0 0 0 0 1|D S T  STOREMEM ACC->MEM[R[SRC]]
0 0 0 1 *
0 0 1 * *
...
0 1 1 0 1|S R C  MUL  ACC*R[SRC]->ACC
0 1 1 1 0|S R C  LOADREG  R[SRC]->ACC
0 1 1 1 1|S R C  LOADMEM MEM[R[SRC]]->ACC
